...
public  class Config {
    ...
    static public int windowWidth = (tileComputed * 16 * 2); // (tileComputed * 20)
    static public int windowHeight = (tileComputed * 9 * 2); // (tileComputed * 15)
    static public int enemySpawnInterval = 70;
